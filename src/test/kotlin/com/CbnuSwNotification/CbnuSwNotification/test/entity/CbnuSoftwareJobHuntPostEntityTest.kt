...
class CbnuSoftwareJobHuntPostEntityTest(
    ...
    fun savePost(){
        ...
        val id = cbnuSoftwareJobHuntPostRepository.save(post)

        Assertions.assertThat(cbnuSoftwareJobHuntPostRepository.findById(id)).isSameAs(post)
    ...
    fun saveLargePost(){
        ...
        val findPost = cbnuSoftwareJobHuntPostRepository.findById(id)!!
